...
FIELD_MAPPING = {
    ...
    # Location fields (projects.csv "Location" = Access "Town" = public.projects.town)
    "Address": "address",
    "Townland": "townland",
    "Town": "town",
    "County": "county",
    # Section (projects.csv "Section" = Access "Short_Description" = public.projects.short_description)
